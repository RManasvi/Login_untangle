			...
			>
				...
				<form onSubmit={handleSubmit} className='space-y-6'>
					...
					<motion.button
						...
						className='w-full bg-gradient-to-r from-blue-500 to-sky-600 text-white font-bold py-3 px-4 rounded-lg shadow-lg hover:from-blue-600 hover:to-sky-700 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-opacity-50 disabled:opacity-50'
					>
